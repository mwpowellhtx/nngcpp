    ...
    namespace exceptions {
        ...
        private:
            ...
            static bool __one_of(ErrorCode_ ec, const Arg_& arg, const Args_&... args) {
                ...
                const auto actual_ec = static_cast<nng::error_code_type>(ec);
                const auto actual_arg = static_cast<nng::error_code_type>(arg);
                ...
                const auto _was_this_one = !(ec || arg) || actual_ec & actual_arg;
        ...
        public:
            ...
            static const char* strerror(int32_t errnum);
        };
    }
}
