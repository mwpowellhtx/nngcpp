...
TEST_CASE("NNG C++ wrapper reconnect works", Catch::Tags(
    ...
    SECTION("We can create a pipeline") {
        ...
        REQUIRE_NOTHROW(pull->GetOptions()->set(_opt_::min_reconnect_duration, reconnect_time));
        REQUIRE_NOTHROW(pull->GetOptions()->set(_opt_::max_reconnect_duration, reconnect_time));
